...
<head>
    ...
    <link href="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css" rel="stylesheet">
        ...
        <form action="submit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" name="profile_image" type="file" accept="image/*" required>
                </div>
            </div>
            <div class="border border-dark p-3 mb-3">    
                <h2>Contact</h2>
                <div class="d-flex justify-content-between mb-3">
                    <div>
                        ...
                        <input type="text" name="first_name" pattern="[a-zA-Z\s]+" 
                        oninvalid="alert('Please enter valid First name');"
                    ...
                    <div>
                        ...
                        pattern="[a-zA-Z\s]+" 
                        oninvalid="alert('Please enter valid Last name');" required>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="phone" name="phone" placeholder="0123456789"
                     pattern="[7-9]{1}[0-9]{9}" oninvalid="alert('Please enter 10 digit Phone No');" required>
                </div>
            </div>
            <div class="border border-dark p-3 mb-3">    
                <h2>Skills (Max:5)</h2>
